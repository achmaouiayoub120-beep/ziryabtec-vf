    ...
    <main className="min-h-screen pt-32 pb-20 bg-[var(--bg)]">
      <SectionWrapper className="max-w-4xl mx-auto text-center">
        ...
        <div className="mx-auto text-[var(--text-secondary)] text-center space-y-8 leading-relaxed">
          ...
          <div>
            <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-4">1. Éditeur du site</h2>
            <p>
          ...
          <div>
            <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-4">2. Hébergement</h2>
            <p>
          ...
          <div>
            <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-4">3. Propriété intellectuelle</h2>
            <p>
          ...
          <div>
            <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-4">4. Données personnelles</h2>
            <p>
