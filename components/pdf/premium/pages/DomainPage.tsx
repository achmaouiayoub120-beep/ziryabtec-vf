  ...
  <Page size="A4" style={[styles.pageLight, { padding: 0 }]}>
    ...
    <View style={{ padding: 40 }}>
      ...
      <View style={{ flexDirection: 'row', borderBottomWidth: 2, borderBottomColor: color, paddingBottom: 10, marginBottom: 15 }}>
        <Text style={[styles.textBody, { width: '15%', fontSize: 10, fontFamily: FONTS.bodyBold, color: COLORS.text.secondary }]}>RÉF</Text>
        <Text style={[styles.textBody, { width: '55%', fontSize: 10, fontFamily: FONTS.bodyBold, color: COLORS.text.secondary }]}>FORMATION</Text>
        <Text style={[styles.textBody, { width: '15%', fontSize: 10, fontFamily: FONTS.bodyBold, color: COLORS.text.secondary }]}>CATÉGORIE</Text>
        <Text style={[styles.textBody, { width: '15%', fontSize: 10, fontFamily: FONTS.bodyBold, color: COLORS.text.secondary, textAlign: 'right' }]}>DURÉE</Text>
      </View>
